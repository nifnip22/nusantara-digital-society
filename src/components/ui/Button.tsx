...
const Button: React.FC<ButtonProps> = ({
	...
	const baseStyles = 'text-sm md:text-md lg:text-lg font-medium px-6 py-3 transition duration-300 hover:shadow-md';

	const variants = {
		primary: 'bg-white text-gray-900 hover:text-[#D7AB6C] border border-gray-300',
		...
		outline: 'border-2 border-[#D7AB6C] text-[#D7AB6C] hover:bg-[#D7AB6C] hover:text-white',
	};

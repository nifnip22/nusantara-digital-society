...
import { EventHeaderProps } from '@/utils/types';
...
export default function EventHeader({
  ...
  return (
    <>
      <h1 className="text-4xl md:text-5xl font-bold leading-normal tracking-wide">
        {eventTitle}
      </h1>
      <div className={'flex flex-col gap-4'}>
        <div
          className={
            'group flex items-start gap-4 p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors'
          }
        >
          ...
          <div>
            <p
              className={
                'text-xs md:text-sm font-semibold text-gray-500 group-hover:text-[#D7AB6C] transition-colors'
              }
            >
              Lokasi
            </p>
      ...
      <Link href={registrationLink || '#'}>
        <Button
          ...
          type={'button'}
          variant={'dark'}
          className={'w-full rounded-full after:content-["_→"]'}
        />
      </Link>
    </>
  );

...
export default function EventGuests({ imageSrc, guestName, guestRole, guestDescription }: EventGuestsProps) {
	return (
		<>
			<div className='flex flex-col gap-y-4'>
				<div className='bg-gray-300 w-full aspect-square rounded-3xl overflow-hidden'>
					<Image src={imageSrc} alt={guestName} width={1500} height={1500} className={'w-full h-full object-cover'} />
				</div>

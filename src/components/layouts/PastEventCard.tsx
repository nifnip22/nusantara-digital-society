		...
		<>
			<div className='group flex flex-col gap-4'>
				...
				<div className='flex flex-col gap-4'>
					<div className='h-20'>
						<h1 className='text-2xl font-bold line-clamp-2 leading-relaxed tracking-wide group-hover:underline group-hover:underline-offset-4 group-hover:decoration-[#D7AB6C]'>{data.title}</h1>
					</div>
					<div className={'group flex items-center gap-4 p-4 bg-gray-50 rounded-xl'}>
						...
						<div>
							...
							<p className={'text-md font-medium line-clamp-1'}>{data.location}</p>
						</div>
					</div>
					<div className={'group flex items-center gap-4 p-4 bg-gray-50 rounded-xl'}>
						<div className={'p-2 bg-[#D7AB6C] bg-opacity-20 rounded-xl'}>
						...
						<div>
							...
							<p className={'text-md font-medium line-clamp-1'}>{data.datetime}</p>
						</div>
					</div>
					<div className={'group flex items-center gap-4 p-4 bg-gray-50 rounded-xl'}>
						<div className={'p-2 bg-[#D7AB6C] bg-opacity-20 rounded-xl'}>
						...
						<div>
							...
							<p className={'text-md font-medium line-clamp-1'}>{data.participantsCount}</p>
						</div>
					</div>

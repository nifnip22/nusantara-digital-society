  ...
  return (
    <>
      <Link href={linkHref} className="group flex flex-col gap-4">
        <div className="relative bg-gray-300 w-full aspect-video rounded-3xl overflow-hidden">
          <Image
            src={imageSrc}
            alt={title}
            width={1500}
          ...
          <div
            className={
              'absolute inset-0 bg-[#D7AB6C]/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300'
            }
          >
        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-2 text-xs opacity-80 line-clamp-1 leading-relaxed tracking-wide">
            <p>{date}</p>

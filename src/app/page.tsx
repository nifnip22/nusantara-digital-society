		...
		<div className={'font-geist-sans overflow-x-hidden'}>
			<div className={'bg-[#f9f2e9] relative'}>
				...
				<section id={'home'} className={'z-10 relative pt-12 pb-[48rem] md:pb-[54rem] md:pt-28 lg:pb-[28rem] xl:pb-[34rem] xl:pt-20'}>
					<main className={'px-6 md:px-16 2xl:px-40 text-center'}>
			...
			<section id={'article'} className={'bg-zinc-50 pt-[56rem] pb-20 md:pt-[60rem] md:pb-32 lg:pt-[36rem] xl:pt-[40rem] xl:pb-40'}>
					...
					<div className={'flex flex-col 2xl:flex-row gap-y-16 2xl:gap-x-12 justify-start 2xl:justify-center items-start mb-20'}>
						<div className={'flex flex-col gap-4'}>
							...
							<Link href={'#'} className={'flex flex-col gap-4 md:gap-6 group'}>
								<div className={'bg-gray-300 w-full 2xl:max-w-5xl rounded-3xl relative overflow-hidden mb-4'}>
									<img src={'/img/Test.jpg'} alt={'Artikel'} className={'w-full h-full object-cover'} />
								...
								<h1 className={'text-xl md:text-2xl xl:text-3xl font-bold w-full 2xl:max-w-[50rem] line-clamp-2 leading-relaxed md:leading-tight group-hover:underline group-hover:underline-offset-4'}>
									Lorem ipsum dolor sit, amet consectetur adipisicing elit.
								</h1>
								<p className={'text-sm md:text-md font-medium w-full 2xl:max-w-[50rem] line-clamp-2 tracking-wide leading-relaxed lg:leading-loose'}>
							...
							<div>
								<Link href='#' className='flex flex-col md:flex-row gap-6 w-full group'>
									...
									<div className={'flex flex-col gap-4 2xl:gap-3'}>
										...
										<h1 className={'text-xl md:text-2xl xl:text-3xl font-bold line-clamp-2 leading-relaxed md:leading-tight max-w-xl group-hover:underline group-hover:underline-offset-4'}>
										...
										<p className={'visible 2xl:hidden text-sm md:text-md font-medium md:max-w-[27rem] line-clamp-2 tracking-wide leading-relaxed lg:leading-loose'}>
